...
class NestedUNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=32, deep_supervision=False, 
                 dropout_p=0.3, filters=[64, 128, 256, 512]):
        super().__init__()
